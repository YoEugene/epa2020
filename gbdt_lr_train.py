...
def gbdt_lr_train(FilePath):
    ...
    # 定义GBDT模型
    gbdt = GradientBoostingRegressor(n_estimators=128, max_depth=5, verbose=1, max_features=0.2)
    ...
    # 预测及AUC评测
    y_pred_gbdt = gbdt.predict(np.array(X_test))[:, 1]
...
if __name__ == '__main__':
    gbdt_lr_train('gbdt_data_2015_2019.csv')